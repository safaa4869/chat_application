...
class ProgressCircleUI extends BasicProgressBarUI {
    ...
    private final Image imageFile;
     public ProgressCircleUI(Progress pro){
         this.pro= pro;
         imageDown = new ImageIcon(getClass().getResource("/com/pfa/icon/down.png")).getImage();
         imageCancel = new ImageIcon(getClass().getResource("/com/pfa/icon/cancel.png")).getImage();
         imageFile = new ImageIcon(getClass().getResource("/com/pfa/icon/file.png")).getImage();
     }
