...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/pfa/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/pfa/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.pfa.swing.JIMSendTextPane();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.PAGE_AXIS));

        txt.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 5, 10));
        txt.setSelectionColor(new java.awt.Color(139, 208, 255));
        add(txt);
    ...
    private com.pfa.swing.JIMSendTextPane txt;
