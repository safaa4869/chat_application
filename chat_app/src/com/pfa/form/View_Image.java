...
public void viewImage(Icon image){
    ...
    private void initComponents() {
        ...
        cmdSave.setBackground(new java.awt.Color(204, 204, 204));
        cmdSave.setForeground(new java.awt.Color(102, 102, 102));
        cmdSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pfa/icon/save.png"))); // NOI18N
